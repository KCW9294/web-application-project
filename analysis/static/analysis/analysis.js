...
$(document).ready(function() {
  ...
  $(document).ready(function() {
    ...
    $("#perspective_btn").click(function() {
      ...
      updateTextInfo("관점전환","관점 전환는 대화상대가 기존과 다른 관점에서 해결책을 찾도록 하는 것으로 정의됩니다. 이 요인은 대화 상대가 생각할 수 있는 질문, 대화상대가 해결책을 찾을 수 있도록 하는 질문, 대화상대의 생각이나 관점을 되돌아보게 하는 질문이 해당됩니다.");
